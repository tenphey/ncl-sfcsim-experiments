#!/usr/bin/env python3
"""
Aggregate latest runs of e24/e25/e26 and draw cross-scenario bar charts.
...
OUT_BASE_DIR = os.path.join(THIS_DIR, "e24_e25_e26")
...
SCENARIOS = [
    {
        ...
        "summary_csv": "grid_e24_summary.csv",
    },
    {
        "exp_dir": "e25",
        "scenario": "b5",
        "condition": "CCR_data ~= IDR_image",
        "summary_csv": "grid_e25_summary.csv",
    },
    {
        "exp_dir": "e26",
        "scenario": "b6",
        "condition": "CCR_data < IDR_image",
        "summary_csv": "grid_e26_summary.csv",
    },
]
...
def draw_grouped_makespan_chart(df, out_path):
    ...
    draw.text(
        (margin_left, 20),
        "E24/E25/E26 Makespan Mean Comparison (Grouped by b4/b5/b6)",
        fill="black",
        font=font_title,
    )
    ...
    # Common-property line (e.g., 1 < NCCR_total < 2)
...
def main():
    ...
    for meta in SCENARIOS:
        ...
        row = {
            ...
            "nccr_constraint": "1 < NCCR_total < 2",
    ...
    out_csv = os.path.join(out_dir, "e24_e25_e26_latest_summary.csv")
    df.to_csv(out_csv, index=False)

    # Plot 0: grouped makespan mean comparison (b4/b5/b6 x HEFT/DHEFT/NHEFT).
    ...
    out_bar_win = os.path.join(out_dir, "e24_e25_e26_win_rate_bar.png")
    draw_bar(
        df=df,
        y_col="win_rate_percent",
        y_label="NHEFT Win Rate over DHEFT (%)",
        title="E24/E25/E26 Latest Runs (1 < NCCR_total < 2)",
        out_path=out_bar_win,
        ylim_min=0.0,
    )

    # Plot 2: median gain (%) by scenario.
    out_bar_gain = os.path.join(out_dir, "e24_e25_e26_gain_median_bar.png")
    draw_bar(
        df=df,
        y_col="gain_N_over_D_median",
        y_label="NHEFT Gain over DHEFT Median (%)",
        title="E24/E25/E26 Median Gain by Scenario",
    ...
    with open(out_txt, "w") as f:
        f.write("E24/E25/E26 latest-run aggregation\n")
    ...
    print("=== E24/E25/E26 latest aggregation completed ===")
