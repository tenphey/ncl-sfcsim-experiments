#!/usr/bin/env python3
"""
Aggregate latest runs of e21/e22/e23 and draw cross-scenario bar charts.
...
OUT_BASE_DIR = os.path.join(THIS_DIR, "e21_e22_e23")
...
SCENARIOS = [
    {
        ...
        "summary_csv": "grid_e21_summary.csv",
    },
    {
        "exp_dir": "e22",
        "scenario": "b2",
        "condition": "CCR_data ~= IDR_image",
        "summary_csv": "grid_e22_summary.csv",
    },
    {
        "exp_dir": "e23",
        "scenario": "b3",
        "condition": "CCR_data < IDR_image",
        "summary_csv": "grid_e23_summary.csv",
    },
]
...
def draw_grouped_makespan_chart(df, out_path):
    ...
    draw.text(
        (margin_left, 20),
        "E21/E22/E23 Makespan Mean Comparison (Grouped by b1/b2/b3)",
        fill="black",
        font=font_title,
    )
    ...
    # Common-property line (e.g., 0 < NCCR_total < 1)
...
def main():
    ...
    for meta in SCENARIOS:
        ...
        row = {
            ...
            "nccr_constraint": "0 < NCCR_total < 1",
    ...
    out_csv = os.path.join(out_dir, "e21_e22_e23_latest_summary.csv")
    df.to_csv(out_csv, index=False)

    # Plot 0: grouped makespan mean comparison (b1/b2/b3 x HEFT/DHEFT/NHEFT).
    ...
    out_bar_win = os.path.join(out_dir, "e21_e22_e23_win_rate_bar.png")
    draw_bar(
        df=df,
        y_col="win_rate_percent",
        y_label="NHEFT Win Rate over DHEFT (%)",
        title="E21/E22/E23 Latest Runs (0 < NCCR_total < 1)",
        out_path=out_bar_win,
        ylim_min=0.0,
    )

    # Plot 2: median gain (%) by scenario.
    out_bar_gain = os.path.join(out_dir, "e21_e22_e23_gain_median_bar.png")
    draw_bar(
        df=df,
        y_col="gain_N_over_D_median",
        y_label="NHEFT Gain over DHEFT Median (%)",
        title="E21/E22/E23 Median Gain by Scenario",
    ...
    with open(out_txt, "w") as f:
        f.write("E21/E22/E23 latest-run aggregation\n")
    ...
    print("=== E21/E22/E23 latest aggregation completed ===")
