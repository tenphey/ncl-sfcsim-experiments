#!/usr/bin/env python3
"""
E17 Experiment: Repository Bandwidth x Concurrent Download Opportunity

Goal:
- Jointly vary repository bandwidth and multiple_sfc_num.
- Keep total workload size fixed.
- Use a download-heavy setting so NHEFT's slot-based advantage is easier to see.

Hypothesis:
- NHEFT should outperform DHEFT most clearly when:
  1) repository bandwidth is high enough to support parallel downloads, and
  2) multiple_sfc_num creates more overlapping download opportunities.

Usage:
  python3 run_experiment.py
  E17_DRY_RUN=1 python3 run_experiment.py
  E17_NUM_SEEDS=10 python3 run_experiment.py
"""
...
REPO_BWS = env_int_list("E17_REPO_BWS", default=[300, 600, 900])
MULTI_SFC_LEVELS = env_int_list("E17_MULTI_SFC_LEVELS", default=[1, 2, 4, 8])

# Fixed knobs chosen from the recent experiment analysis
EFFECTIVE_TOTAL_VNF_NUM = env_int("E17_TOTAL_VNF_NUM", default=320)
VNF_TYPE_MIN = env_int("E17_VNF_TYPE_MIN", default=1)
VNF_TYPE_MAX = env_int("E17_VNF_TYPE_MAX", default=20)
VNF_IMAGE_SIZE_MIN = env_int("E17_IMAGE_MIN", default=5000)
VNF_IMAGE_SIZE_MAX = env_int("E17_IMAGE_MAX", default=7000)
DATACENTER_EXTERNALBW_MIN = env_int("E17_DATACENTER_EXTERNALBW_MIN", default=500)
DATACENTER_EXTERNALBW_MAX = env_int("E17_DATACENTER_EXTERNALBW_MAX", default=1000)
HOST_BW_MIN = env_int("E17_HOST_BW_MIN", default=1000)
HOST_BW_MAX = env_int("E17_HOST_BW_MAX", default=2000)

DRY_RUN = env_int("E17_DRY_RUN", default=0) == 1
LIMIT_RUNS = env_int("E17_LIMIT_RUNS", default=0)

# Seeding
MASTER_SEED = env_int("E17_MASTER_SEED", default=150)
NUM_SEEDS_DEFAULT = 30
NUM_SEEDS = env_int("E17_NUM_SEEDS", default=NUM_SEEDS_DEFAULT)
...
def main():
    ...
    csv_path = os.path.join(out_dir, "grid_e17_results.csv")
    results = []
    ...
    print("=== E17 Experiment: Repository BW x Concurrent Download Opportunity ===")
    ...
    manifest = {
        "experiment": "E17 - Repository BW x Concurrent Download Opportunity",
        "timestamp": timestamp,
