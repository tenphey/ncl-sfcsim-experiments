# E38Y: Standalone GHEFT / IRT-Only Gate
...
```bash
E38Y_NUM_SEEDS=1 E38Y_LIMIT_RUNS=1           experiments/.venv/bin/python           experiments/four/e38y/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python           experiments/four/e38y/run_experiment.py
```

Dry run:

```bash
E38Y_NUM_SEEDS=1 E38Y_LIMIT_RUNS=1 E38Y_DRY_RUN=1           experiments/.venv/bin/python           experiments/four/e38y/run_experiment.py
```

Optional override:

```bash
E38Y_BASE_PROPERTIES=/absolute/path/to/file.properties
```
