# E34X: Standalone GHEFT / IRT-Only Gate
...
```bash
E34X_NUM_SEEDS=1 E34X_LIMIT_RUNS=1           experiments/.venv/bin/python           experiments/four/e34x/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python           experiments/four/e34x/run_experiment.py
```

Dry run:

```bash
E34X_NUM_SEEDS=1 E34X_LIMIT_RUNS=1 E34X_DRY_RUN=1           experiments/.venv/bin/python           experiments/four/e34x/run_experiment.py
```

Optional override:

```bash
E34X_BASE_PROPERTIES=/absolute/path/to/file.properties
```
