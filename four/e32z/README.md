# E32Z: Standalone GHEFT / IRT-Only Gate
...
```bash
E32Z_NUM_SEEDS=1 E32Z_LIMIT_RUNS=1           experiments/.venv/bin/python           experiments/four/e32z/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python           experiments/four/e32z/run_experiment.py
```

Dry run:

```bash
E32Z_NUM_SEEDS=1 E32Z_LIMIT_RUNS=1 E32Z_DRY_RUN=1           experiments/.venv/bin/python           experiments/four/e32z/run_experiment.py
```

Optional override:

```bash
E32Z_BASE_PROPERTIES=/absolute/path/to/file.properties
```
