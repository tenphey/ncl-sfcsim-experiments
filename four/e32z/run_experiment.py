#!/usr/bin/env python3
"""Standalone GHEFT runner for E32Z."""
...
GATE_VARIANT = {
    ...
    "irt_advantage": "1",
    "gate_logic": "all",
    "description": "Run only GHEFT with the IRT-only opening gate under the shared E02Z scenario.",
}
