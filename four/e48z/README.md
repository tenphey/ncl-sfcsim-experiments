# E48Z: Standalone GHEFT / DRT-Or-IRT Gate
...
```bash
E48Z_NUM_SEEDS=1 E48Z_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e48z/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e48z/run_experiment.py
```

Dry run:

```bash
E48Z_NUM_SEEDS=1 E48Z_LIMIT_RUNS=1 E48Z_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e48z/run_experiment.py
```

Optional override:

```bash
E48Z_BASE_PROPERTIES=/absolute/path/to/file.properties
```
