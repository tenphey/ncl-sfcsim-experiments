# E47X: Standalone GHEFT / DRT-Or-IRT Gate
...
```bash
E47X_NUM_SEEDS=1 E47X_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e47x/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e47x/run_experiment.py
```

Dry run:

```bash
E47X_NUM_SEEDS=1 E47X_LIMIT_RUNS=1 E47X_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e47x/run_experiment.py
```

Optional override:

```bash
E47X_BASE_PROPERTIES=/absolute/path/to/file.properties
```
