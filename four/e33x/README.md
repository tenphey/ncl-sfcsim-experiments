# E33X: Standalone GHEFT / IRT-Only Gate
...
```bash
E33X_NUM_SEEDS=1 E33X_LIMIT_RUNS=1           experiments/.venv/bin/python           experiments/four/e33x/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python           experiments/four/e33x/run_experiment.py
```

Dry run:

```bash
E33X_NUM_SEEDS=1 E33X_LIMIT_RUNS=1 E33X_DRY_RUN=1           experiments/.venv/bin/python           experiments/four/e33x/run_experiment.py
```

Optional override:

```bash
E33X_BASE_PROPERTIES=/absolute/path/to/file.properties
```
