# E45Z: Standalone GHEFT / DRT-Or-IRT Gate
...
```bash
E45Z_NUM_SEEDS=1 E45Z_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e45z/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e45z/run_experiment.py
```

Dry run:

```bash
E45Z_NUM_SEEDS=1 E45Z_LIMIT_RUNS=1 E45Z_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e45z/run_experiment.py
```

Optional override:

```bash
E45Z_BASE_PROPERTIES=/absolute/path/to/file.properties
```
