# E07Z: Shared Baseline Scenario Run
...
```text
experiments/four/e07z/b07z.properties
```
...
```bash
E07Z_NUM_SEEDS=1 E07Z_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e07z/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e07z/run_experiment.py
```

Dry run:

```bash
E07Z_NUM_SEEDS=1 E07Z_LIMIT_RUNS=1 E07Z_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e07z/run_experiment.py
```

Optional override:

```bash
E07Z_BASE_PROPERTIES=/absolute/path/to/file.properties
```
...
- `e07z` as the common baseline side
