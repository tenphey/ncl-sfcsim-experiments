# E02Z: Shared Baseline Scenario Run
...
```text
experiments/four/e02z/b02z.properties
```
...
```bash
E02Z_NUM_SEEDS=1 E02Z_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e02z/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e02z/run_experiment.py
```

Dry run:

```bash
E02Z_NUM_SEEDS=1 E02Z_LIMIT_RUNS=1 E02Z_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e02z/run_experiment.py
```

Optional override:

```bash
E02Z_BASE_PROPERTIES=/absolute/path/to/file.properties
```
...
- `e02z` as the common baseline side
