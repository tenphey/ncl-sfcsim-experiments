# E06Z: Shared Baseline Scenario Run
...
```text
experiments/four/e06z/b06z.properties
```
...
```bash
E06Z_NUM_SEEDS=1 E06Z_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e06z/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e06z/run_experiment.py
```

Dry run:

```bash
E06Z_NUM_SEEDS=1 E06Z_LIMIT_RUNS=1 E06Z_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e06z/run_experiment.py
```

Optional override:

```bash
E06Z_BASE_PROPERTIES=/absolute/path/to/file.properties
```
...
- `e06z` as the common baseline side
