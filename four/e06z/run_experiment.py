#!/usr/bin/env python3
"""Shared baseline runner for E06Z."""
...
if __name__ == "__main__":
    run_single_baseline_experiment(
        ...
        experiment_code="e06z",
        raw_csv_name="e06z_results.csv",
        base_properties_path=os.path.join(THIS_DIR, "b06z.properties"),
        purpose=(
            "Shared baseline run for E06Z. "
