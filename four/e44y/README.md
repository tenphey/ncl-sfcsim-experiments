# E44Y: Standalone GHEFT / DRT-Or-IRT Gate
...
```bash
E44Y_NUM_SEEDS=1 E44Y_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e44y/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e44y/run_experiment.py
```

Dry run:

```bash
E44Y_NUM_SEEDS=1 E44Y_LIMIT_RUNS=1 E44Y_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e44y/run_experiment.py
```

Optional override:

```bash
E44Y_BASE_PROPERTIES=/absolute/path/to/file.properties
```
