# E35X: Standalone GHEFT / IRT-Only Gate
...
```bash
E35X_NUM_SEEDS=1 E35X_LIMIT_RUNS=1           experiments/.venv/bin/python           experiments/four/e35x/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python           experiments/four/e35x/run_experiment.py
```

Dry run:

```bash
E35X_NUM_SEEDS=1 E35X_LIMIT_RUNS=1 E35X_DRY_RUN=1           experiments/.venv/bin/python           experiments/four/e35x/run_experiment.py
```

Optional override:

```bash
E35X_BASE_PROPERTIES=/absolute/path/to/file.properties
```
