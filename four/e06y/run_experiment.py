#!/usr/bin/env python3
"""Shared baseline runner for E06Y."""
...
if __name__ == "__main__":
    run_single_baseline_experiment(
        ...
        experiment_code="e06y",
        raw_csv_name="e06y_results.csv",
        base_properties_path=os.path.join(THIS_DIR, "b06y.properties"),
        purpose=(
            "Shared baseline run for E06Y. "
