# E06Y: Shared Baseline Scenario Run
...
```text
experiments/four/e06y/b06y.properties
```
...
```bash
E06Y_NUM_SEEDS=1 E06Y_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e06y/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e06y/run_experiment.py
```

Dry run:

```bash
E06Y_NUM_SEEDS=1 E06Y_LIMIT_RUNS=1 E06Y_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e06y/run_experiment.py
```

Optional override:

```bash
E06Y_BASE_PROPERTIES=/absolute/path/to/file.properties
```
...
- `e06y` as the common baseline side
