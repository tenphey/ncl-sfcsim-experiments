#!/usr/bin/env python3
"""Shared baseline runner for E02X."""
...
if __name__ == "__main__":
    run_single_baseline_experiment(
        ...
        experiment_code="e02x",
        raw_csv_name="e02x_results.csv",
        base_properties_path=os.path.join(THIS_DIR, "b02x.properties"),
        purpose=(
            "Shared baseline run for E02X. "
