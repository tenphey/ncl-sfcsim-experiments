# E41X: Standalone GHEFT / DRT-Or-IRT Gate
...
```bash
E41X_NUM_SEEDS=1 E41X_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e41x/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e41x/run_experiment.py
```

Dry run:

```bash
E41X_NUM_SEEDS=1 E41X_LIMIT_RUNS=1 E41X_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e41x/run_experiment.py
```

Optional override:

```bash
E41X_BASE_PROPERTIES=/absolute/path/to/file.properties
```
