# E47Z: Standalone GHEFT / DRT-Or-IRT Gate
...
```bash
E47Z_NUM_SEEDS=1 E47Z_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e47z/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e47z/run_experiment.py
```

Dry run:

```bash
E47Z_NUM_SEEDS=1 E47Z_LIMIT_RUNS=1 E47Z_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e47z/run_experiment.py
```

Optional override:

```bash
E47Z_BASE_PROPERTIES=/absolute/path/to/file.properties
```
