# E47Y: Standalone GHEFT / DRT-Or-IRT Gate
...
```bash
E47Y_NUM_SEEDS=1 E47Y_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e47y/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e47y/run_experiment.py
```

Dry run:

```bash
E47Y_NUM_SEEDS=1 E47Y_LIMIT_RUNS=1 E47Y_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e47y/run_experiment.py
```

Optional override:

```bash
E47Y_BASE_PROPERTIES=/absolute/path/to/file.properties
```
