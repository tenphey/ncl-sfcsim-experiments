#!/usr/bin/env python3
"""Shared baseline runner for E08X."""
...
if __name__ == "__main__":
    run_single_baseline_experiment(
        ...
        experiment_code="e08x",
        raw_csv_name="e08x_results.csv",
        base_properties_path=os.path.join(THIS_DIR, "b08x.properties"),
        purpose=(
            "Shared baseline run for E08X. "
