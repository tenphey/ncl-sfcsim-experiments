# E43Y: Standalone GHEFT / DRT-Or-IRT Gate
...
```bash
E43Y_NUM_SEEDS=1 E43Y_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e43y/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e43y/run_experiment.py
```

Dry run:

```bash
E43Y_NUM_SEEDS=1 E43Y_LIMIT_RUNS=1 E43Y_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e43y/run_experiment.py
```

Optional override:

```bash
E43Y_BASE_PROPERTIES=/absolute/path/to/file.properties
```
