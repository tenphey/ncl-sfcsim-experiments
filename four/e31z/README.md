# E31Z: Standalone GHEFT / IRT-Only Gate
...
```bash
E31Z_NUM_SEEDS=1 E31Z_LIMIT_RUNS=1           experiments/.venv/bin/python           experiments/four/e31z/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python           experiments/four/e31z/run_experiment.py
```

Dry run:

```bash
E31Z_NUM_SEEDS=1 E31Z_LIMIT_RUNS=1 E31Z_DRY_RUN=1           experiments/.venv/bin/python           experiments/four/e31z/run_experiment.py
```

Optional override:

```bash
E31Z_BASE_PROPERTIES=/absolute/path/to/file.properties
```
