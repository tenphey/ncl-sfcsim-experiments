# E35Z: Standalone GHEFT / IRT-Only Gate
...
```bash
E35Z_NUM_SEEDS=1 E35Z_LIMIT_RUNS=1           experiments/.venv/bin/python           experiments/four/e35z/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python           experiments/four/e35z/run_experiment.py
```

Dry run:

```bash
E35Z_NUM_SEEDS=1 E35Z_LIMIT_RUNS=1 E35Z_DRY_RUN=1           experiments/.venv/bin/python           experiments/four/e35z/run_experiment.py
```

Optional override:

```bash
E35Z_BASE_PROPERTIES=/absolute/path/to/file.properties
```
