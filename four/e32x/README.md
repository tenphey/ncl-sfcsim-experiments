# E32X: Standalone GHEFT / IRT-Only Gate
...
```bash
E32X_NUM_SEEDS=1 E32X_LIMIT_RUNS=1           experiments/.venv/bin/python           experiments/four/e32x/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python           experiments/four/e32x/run_experiment.py
```

Dry run:

```bash
E32X_NUM_SEEDS=1 E32X_LIMIT_RUNS=1 E32X_DRY_RUN=1           experiments/.venv/bin/python           experiments/four/e32x/run_experiment.py
```

Optional override:

```bash
E32X_BASE_PROPERTIES=/absolute/path/to/file.properties
```
