#!/usr/bin/env python3
"""Standalone GHEFT runner for E26X."""
...
GATE_VARIANT = {
    ...
    "irt_advantage": "0",
    "gate_logic": "all",
    "description": "Run only GHEFT with the DRT-only opening gate under the shared E06X scenario.",
}
