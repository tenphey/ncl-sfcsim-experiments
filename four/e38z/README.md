# E38Z: Standalone GHEFT / IRT-Only Gate
...
```bash
E38Z_NUM_SEEDS=1 E38Z_LIMIT_RUNS=1           experiments/.venv/bin/python           experiments/four/e38z/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python           experiments/four/e38z/run_experiment.py
```

Dry run:

```bash
E38Z_NUM_SEEDS=1 E38Z_LIMIT_RUNS=1 E38Z_DRY_RUN=1           experiments/.venv/bin/python           experiments/four/e38z/run_experiment.py
```

Optional override:

```bash
E38Z_BASE_PROPERTIES=/absolute/path/to/file.properties
```
