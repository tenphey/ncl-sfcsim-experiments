# E46Y: Standalone GHEFT / DRT-Or-IRT Gate
...
```bash
E46Y_NUM_SEEDS=1 E46Y_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e46y/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e46y/run_experiment.py
```

Dry run:

```bash
E46Y_NUM_SEEDS=1 E46Y_LIMIT_RUNS=1 E46Y_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e46y/run_experiment.py
```

Optional override:

```bash
E46Y_BASE_PROPERTIES=/absolute/path/to/file.properties
```
