# E32Y: Standalone GHEFT / IRT-Only Gate
...
```bash
E32Y_NUM_SEEDS=1 E32Y_LIMIT_RUNS=1           experiments/.venv/bin/python           experiments/four/e32y/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python           experiments/four/e32y/run_experiment.py
```

Dry run:

```bash
E32Y_NUM_SEEDS=1 E32Y_LIMIT_RUNS=1 E32Y_DRY_RUN=1           experiments/.venv/bin/python           experiments/four/e32y/run_experiment.py
```

Optional override:

```bash
E32Y_BASE_PROPERTIES=/absolute/path/to/file.properties
```
