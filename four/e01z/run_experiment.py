#!/usr/bin/env python3
"""Shared baseline runner for E01Z."""
...
if __name__ == "__main__":
    run_single_baseline_experiment(
        ...
        experiment_code="e01z",
        raw_csv_name="e01z_results.csv",
        base_properties_path=os.path.join(THIS_DIR, "b01z.properties"),
        purpose=(
            "Shared baseline run for E01Z. "
