# E01Z: Shared Baseline Scenario Run
...
```text
experiments/four/e01z/b01z.properties
```
...
```bash
E01Z_NUM_SEEDS=1 E01Z_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e01z/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e01z/run_experiment.py
```

Dry run:

```bash
E01Z_NUM_SEEDS=1 E01Z_LIMIT_RUNS=1 E01Z_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e01z/run_experiment.py
```

Optional override:

```bash
E01Z_BASE_PROPERTIES=/absolute/path/to/file.properties
```
...
- `e01z` as the common baseline side
