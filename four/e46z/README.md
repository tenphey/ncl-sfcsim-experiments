# E46Z: Standalone GHEFT / DRT-Or-IRT Gate
...
```bash
E46Z_NUM_SEEDS=1 E46Z_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e46z/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e46z/run_experiment.py
```

Dry run:

```bash
E46Z_NUM_SEEDS=1 E46Z_LIMIT_RUNS=1 E46Z_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e46z/run_experiment.py
```

Optional override:

```bash
E46Z_BASE_PROPERTIES=/absolute/path/to/file.properties
```
