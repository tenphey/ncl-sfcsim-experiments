#!/usr/bin/env python3
"""Shared baseline runner for E08Z."""
...
if __name__ == "__main__":
    run_single_baseline_experiment(
        ...
        experiment_code="e08z",
        raw_csv_name="e08z_results.csv",
        base_properties_path=os.path.join(THIS_DIR, "b08z.properties"),
        purpose=(
            "Shared baseline run for E08Z. "
