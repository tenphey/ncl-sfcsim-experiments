# E08Z: Shared Baseline Scenario Run
...
```text
experiments/four/e08z/b08z.properties
```
...
```bash
E08Z_NUM_SEEDS=1 E08Z_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e08z/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e08z/run_experiment.py
```

Dry run:

```bash
E08Z_NUM_SEEDS=1 E08Z_LIMIT_RUNS=1 E08Z_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e08z/run_experiment.py
```

Optional override:

```bash
E08Z_BASE_PROPERTIES=/absolute/path/to/file.properties
```
...
- `e08z` as the common baseline side
