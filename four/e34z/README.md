# E34Z: Standalone GHEFT / IRT-Only Gate
...
```bash
E34Z_NUM_SEEDS=1 E34Z_LIMIT_RUNS=1           experiments/.venv/bin/python           experiments/four/e34z/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python           experiments/four/e34z/run_experiment.py
```

Dry run:

```bash
E34Z_NUM_SEEDS=1 E34Z_LIMIT_RUNS=1 E34Z_DRY_RUN=1           experiments/.venv/bin/python           experiments/four/e34z/run_experiment.py
```

Optional override:

```bash
E34Z_BASE_PROPERTIES=/absolute/path/to/file.properties
```
