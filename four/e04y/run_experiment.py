#!/usr/bin/env python3
"""Shared baseline runner for E04Y."""
...
if __name__ == "__main__":
    run_single_baseline_experiment(
        ...
        experiment_code="e04y",
        raw_csv_name="e04y_results.csv",
        base_properties_path=os.path.join(THIS_DIR, "b04y.properties"),
        purpose=(
            "Shared baseline run for E04Y. "
