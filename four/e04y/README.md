# E04Y: Shared Baseline Scenario Run
...
```text
experiments/four/e04y/b04y.properties
```
...
```bash
E04Y_NUM_SEEDS=1 E04Y_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e04y/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e04y/run_experiment.py
```

Dry run:

```bash
E04Y_NUM_SEEDS=1 E04Y_LIMIT_RUNS=1 E04Y_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e04y/run_experiment.py
```

Optional override:

```bash
E04Y_BASE_PROPERTIES=/absolute/path/to/file.properties
```
...
- `e04y` as the common baseline side
