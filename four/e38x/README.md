# E38X: Standalone GHEFT / IRT-Only Gate
...
```bash
E38X_NUM_SEEDS=1 E38X_LIMIT_RUNS=1           experiments/.venv/bin/python           experiments/four/e38x/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python           experiments/four/e38x/run_experiment.py
```

Dry run:

```bash
E38X_NUM_SEEDS=1 E38X_LIMIT_RUNS=1 E38X_DRY_RUN=1           experiments/.venv/bin/python           experiments/four/e38x/run_experiment.py
```

Optional override:

```bash
E38X_BASE_PROPERTIES=/absolute/path/to/file.properties
```
