#!/usr/bin/env python3
"""Shared baseline runner for E01Y."""
...
if __name__ == "__main__":
    run_single_baseline_experiment(
        ...
        experiment_code="e01y",
        raw_csv_name="e01y_results.csv",
        base_properties_path=os.path.join(THIS_DIR, "b01y.properties"),
        purpose=(
            "Shared baseline run for E01Y. "
