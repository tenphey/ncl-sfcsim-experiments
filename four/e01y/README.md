# E01Y: Shared Baseline Scenario Run
...
```text
experiments/four/e01y/b01y.properties
```
...
```bash
E01Y_NUM_SEEDS=1 E01Y_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e01y/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e01y/run_experiment.py
```

Dry run:

```bash
E01Y_NUM_SEEDS=1 E01Y_LIMIT_RUNS=1 E01Y_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e01y/run_experiment.py
```

Optional override:

```bash
E01Y_BASE_PROPERTIES=/absolute/path/to/file.properties
```
...
- `e01y` as the common baseline side
