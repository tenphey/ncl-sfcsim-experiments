# E37Y: Standalone GHEFT / IRT-Only Gate
...
```bash
E37Y_NUM_SEEDS=1 E37Y_LIMIT_RUNS=1           experiments/.venv/bin/python           experiments/four/e37y/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python           experiments/four/e37y/run_experiment.py
```

Dry run:

```bash
E37Y_NUM_SEEDS=1 E37Y_LIMIT_RUNS=1 E37Y_DRY_RUN=1           experiments/.venv/bin/python           experiments/four/e37y/run_experiment.py
```

Optional override:

```bash
E37Y_BASE_PROPERTIES=/absolute/path/to/file.properties
```
