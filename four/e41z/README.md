# E41Z: Standalone GHEFT / DRT-Or-IRT Gate
...
```bash
E41Z_NUM_SEEDS=1 E41Z_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e41z/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e41z/run_experiment.py
```

Dry run:

```bash
E41Z_NUM_SEEDS=1 E41Z_LIMIT_RUNS=1 E41Z_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e41z/run_experiment.py
```

Optional override:

```bash
E41Z_BASE_PROPERTIES=/absolute/path/to/file.properties
```
