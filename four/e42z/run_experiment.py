#!/usr/bin/env python3
"""Standalone GHEFT runner for E42Z."""
...
GATE_VARIANT = {
    ...
    "irt_advantage": "1",
    "gate_logic": "any",
    "description": "Run only GHEFT with the DRT-or-IRT opening gate under the shared E02Z scenario.",
}
