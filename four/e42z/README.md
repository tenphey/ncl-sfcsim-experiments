# E42Z: Standalone GHEFT / DRT-Or-IRT Gate
...
```bash
E42Z_NUM_SEEDS=1 E42Z_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e42z/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e42z/run_experiment.py
```

Dry run:

```bash
E42Z_NUM_SEEDS=1 E42Z_LIMIT_RUNS=1 E42Z_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e42z/run_experiment.py
```

Optional override:

```bash
E42Z_BASE_PROPERTIES=/absolute/path/to/file.properties
```
