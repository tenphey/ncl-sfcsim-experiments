# E35Y: Standalone GHEFT / IRT-Only Gate
...
```bash
E35Y_NUM_SEEDS=1 E35Y_LIMIT_RUNS=1           experiments/.venv/bin/python           experiments/four/e35y/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python           experiments/four/e35y/run_experiment.py
```

Dry run:

```bash
E35Y_NUM_SEEDS=1 E35Y_LIMIT_RUNS=1 E35Y_DRY_RUN=1           experiments/.venv/bin/python           experiments/four/e35y/run_experiment.py
```

Optional override:

```bash
E35Y_BASE_PROPERTIES=/absolute/path/to/file.properties
```
