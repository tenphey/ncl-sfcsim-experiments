# E43X: Standalone GHEFT / DRT-Or-IRT Gate
...
```bash
E43X_NUM_SEEDS=1 E43X_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e43x/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e43x/run_experiment.py
```

Dry run:

```bash
E43X_NUM_SEEDS=1 E43X_LIMIT_RUNS=1 E43X_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e43x/run_experiment.py
```

Optional override:

```bash
E43X_BASE_PROPERTIES=/absolute/path/to/file.properties
```
