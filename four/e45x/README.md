# E45X: Standalone GHEFT / DRT-Or-IRT Gate
...
```bash
E45X_NUM_SEEDS=1 E45X_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e45x/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e45x/run_experiment.py
```

Dry run:

```bash
E45X_NUM_SEEDS=1 E45X_LIMIT_RUNS=1 E45X_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e45x/run_experiment.py
```

Optional override:

```bash
E45X_BASE_PROPERTIES=/absolute/path/to/file.properties
```
