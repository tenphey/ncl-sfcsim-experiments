# E41Y: Standalone GHEFT / DRT-Or-IRT Gate
...
```bash
E41Y_NUM_SEEDS=1 E41Y_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e41y/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e41y/run_experiment.py
```

Dry run:

```bash
E41Y_NUM_SEEDS=1 E41Y_LIMIT_RUNS=1 E41Y_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e41y/run_experiment.py
```

Optional override:

```bash
E41Y_BASE_PROPERTIES=/absolute/path/to/file.properties
```
