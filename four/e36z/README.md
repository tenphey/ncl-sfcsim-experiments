# E36Z: Standalone GHEFT / IRT-Only Gate
...
```bash
E36Z_NUM_SEEDS=1 E36Z_LIMIT_RUNS=1           experiments/.venv/bin/python           experiments/four/e36z/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python           experiments/four/e36z/run_experiment.py
```

Dry run:

```bash
E36Z_NUM_SEEDS=1 E36Z_LIMIT_RUNS=1 E36Z_DRY_RUN=1           experiments/.venv/bin/python           experiments/four/e36z/run_experiment.py
```

Optional override:

```bash
E36Z_BASE_PROPERTIES=/absolute/path/to/file.properties
```
