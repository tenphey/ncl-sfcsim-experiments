# E37X: Standalone GHEFT / IRT-Only Gate
...
```bash
E37X_NUM_SEEDS=1 E37X_LIMIT_RUNS=1           experiments/.venv/bin/python           experiments/four/e37x/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python           experiments/four/e37x/run_experiment.py
```

Dry run:

```bash
E37X_NUM_SEEDS=1 E37X_LIMIT_RUNS=1 E37X_DRY_RUN=1           experiments/.venv/bin/python           experiments/four/e37x/run_experiment.py
```

Optional override:

```bash
E37X_BASE_PROPERTIES=/absolute/path/to/file.properties
```
