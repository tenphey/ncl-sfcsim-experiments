#!/usr/bin/env python3
"""Shared baseline runner for E04Z."""
...
if __name__ == "__main__":
    run_single_baseline_experiment(
        ...
        experiment_code="e04z",
        raw_csv_name="e04z_results.csv",
        base_properties_path=os.path.join(THIS_DIR, "b04z.properties"),
        purpose=(
            "Shared baseline run for E04Z. "
