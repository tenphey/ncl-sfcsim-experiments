# E04Z: Shared Baseline Scenario Run
...
```text
experiments/four/e04z/b04z.properties
```
...
```bash
E04Z_NUM_SEEDS=1 E04Z_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e04z/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e04z/run_experiment.py
```

Dry run:

```bash
E04Z_NUM_SEEDS=1 E04Z_LIMIT_RUNS=1 E04Z_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e04z/run_experiment.py
```

Optional override:

```bash
E04Z_BASE_PROPERTIES=/absolute/path/to/file.properties
```
...
- `e04z` as the common baseline side
