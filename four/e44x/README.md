# E44X: Standalone GHEFT / DRT-Or-IRT Gate
...
```bash
E44X_NUM_SEEDS=1 E44X_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e44x/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e44x/run_experiment.py
```

Dry run:

```bash
E44X_NUM_SEEDS=1 E44X_LIMIT_RUNS=1 E44X_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e44x/run_experiment.py
```

Optional override:

```bash
E44X_BASE_PROPERTIES=/absolute/path/to/file.properties
```
