# E45Y: Standalone GHEFT / DRT-Or-IRT Gate
...
```bash
E45Y_NUM_SEEDS=1 E45Y_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e45y/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e45y/run_experiment.py
```

Dry run:

```bash
E45Y_NUM_SEEDS=1 E45Y_LIMIT_RUNS=1 E45Y_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e45y/run_experiment.py
```

Optional override:

```bash
E45Y_BASE_PROPERTIES=/absolute/path/to/file.properties
```
