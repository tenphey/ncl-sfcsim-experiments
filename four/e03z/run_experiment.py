#!/usr/bin/env python3
"""Shared baseline runner for E03Z."""
...
if __name__ == "__main__":
    run_single_baseline_experiment(
        ...
        experiment_code="e03z",
        raw_csv_name="e03z_results.csv",
        base_properties_path=os.path.join(THIS_DIR, "b03z.properties"),
        purpose=(
            "Shared baseline run for E03Z. "
