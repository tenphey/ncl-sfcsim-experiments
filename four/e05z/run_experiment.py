#!/usr/bin/env python3
"""Shared baseline runner for E05Z."""
...
if __name__ == "__main__":
    run_single_baseline_experiment(
        ...
        experiment_code="e05z",
        raw_csv_name="e05z_results.csv",
        base_properties_path=os.path.join(THIS_DIR, "b05z.properties"),
        purpose=(
            "Shared baseline run for E05Z. "
