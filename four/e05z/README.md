# E05Z: Shared Baseline Scenario Run
...
```text
experiments/four/e05z/b05z.properties
```
...
```bash
E05Z_NUM_SEEDS=1 E05Z_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e05z/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e05z/run_experiment.py
```

Dry run:

```bash
E05Z_NUM_SEEDS=1 E05Z_LIMIT_RUNS=1 E05Z_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e05z/run_experiment.py
```

Optional override:

```bash
E05Z_BASE_PROPERTIES=/absolute/path/to/file.properties
```
...
- `e05z` as the common baseline side
