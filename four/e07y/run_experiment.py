#!/usr/bin/env python3
"""Shared baseline runner for E07Y."""
...
if __name__ == "__main__":
    run_single_baseline_experiment(
        ...
        experiment_code="e07y",
        raw_csv_name="e07y_results.csv",
        base_properties_path=os.path.join(THIS_DIR, "b07y.properties"),
        purpose=(
            "Shared baseline run for E07Y. "
