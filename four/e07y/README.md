# E07Y: Shared Baseline Scenario Run
...
```text
experiments/four/e07y/b07y.properties
```
...
```bash
E07Y_NUM_SEEDS=1 E07Y_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e07y/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e07y/run_experiment.py
```

Dry run:

```bash
E07Y_NUM_SEEDS=1 E07Y_LIMIT_RUNS=1 E07Y_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e07y/run_experiment.py
```

Optional override:

```bash
E07Y_BASE_PROPERTIES=/absolute/path/to/file.properties
```
...
- `e07y` as the common baseline side
