#!/usr/bin/env python3
"""Shared runner for standalone GHEFT experiments in experiments/four."""
...
def run_single_gheft_experiment(experiment_dir, experiment_code, raw_csv_name, base_properties_path, gate_variant, purpose):
    ...
    manifest = {
        ...
        "loop_order": "seed_only_single_java_invocation_gheft_only",
    ...
    print(f"=== {experiment_code.upper()}: standalone GHEFT ===")
    print(f"Base properties: {resolved_base_properties}")
    print(f"Master seed: {master_seed}")
    print(f"Number of seeds: {num_seeds}")
    print("This runner executes only GHEFT.")
    print("HEFT/DHEFT/NHEFT baselines should be obtained from the shared e01-e08 scenario runs.")
    print(
        f"Gate settings: tolerance={gate_variant['tolerance']}, "
        ...
        f"gate_logic={gate_variant['gate_logic']}"
    )
    ...
    with open(csv_path, "w", newline="", encoding="utf-8") as csv_file:
        ...
        try:
            for seed in seeds:
                ...
                properties["run_heft"] = "0"
                properties["run_dheft"] = "0"
                properties["run_nheft"] = "0"
                properties["run_nheft_mode2"] = "1"
                properties["nheft_mode2_enabled"] = "1"
                properties["nheft_mode2_label"] = gate_variant["display_label"]
                properties["nheft_mode2_vcpu_eft_tolerance"] = gate_variant["tolerance"]
                properties["nheft_mode2_open_requires_comp_advantage"] = gate_variant["comp_advantage"]
                properties["nheft_mode2_open_requires_drt_advantage"] = gate_variant["drt_advantage"]
                properties["nheft_mode2_open_requires_irt_advantage"] = gate_variant["irt_advantage"]
                properties["nheft_mode2_open_gate_logic"] = gate_variant["gate_logic"]
