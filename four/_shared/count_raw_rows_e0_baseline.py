#!/usr/bin/env python3
"""Count latest raw-result rows for the full e0 baseline series.

This script scans experiments/four/e01x ... e08z, picks the latest `run_*`
