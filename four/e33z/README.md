# E33Z: Standalone GHEFT / IRT-Only Gate
...
```bash
E33Z_NUM_SEEDS=1 E33Z_LIMIT_RUNS=1           experiments/.venv/bin/python           experiments/four/e33z/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python           experiments/four/e33z/run_experiment.py
```

Dry run:

```bash
E33Z_NUM_SEEDS=1 E33Z_LIMIT_RUNS=1 E33Z_DRY_RUN=1           experiments/.venv/bin/python           experiments/four/e33z/run_experiment.py
```

Optional override:

```bash
E33Z_BASE_PROPERTIES=/absolute/path/to/file.properties
```
