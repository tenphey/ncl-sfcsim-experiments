# E03Y: Shared Baseline Scenario Run
...
```text
experiments/four/e03y/b03y.properties
```
...
```bash
E03Y_NUM_SEEDS=1 E03Y_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e03y/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e03y/run_experiment.py
```

Dry run:

```bash
E03Y_NUM_SEEDS=1 E03Y_LIMIT_RUNS=1 E03Y_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e03y/run_experiment.py
```

Optional override:

```bash
E03Y_BASE_PROPERTIES=/absolute/path/to/file.properties
```
...
- `e03y` as the common baseline side
