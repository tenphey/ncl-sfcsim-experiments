#!/usr/bin/env python3
"""Shared baseline runner for E03Y."""
...
if __name__ == "__main__":
    run_single_baseline_experiment(
        ...
        experiment_code="e03y",
        raw_csv_name="e03y_results.csv",
        base_properties_path=os.path.join(THIS_DIR, "b03y.properties"),
        purpose=(
            "Shared baseline run for E03Y. "
