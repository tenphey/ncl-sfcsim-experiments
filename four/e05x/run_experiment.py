#!/usr/bin/env python3
"""Shared baseline runner for E05X."""
...
if __name__ == "__main__":
    run_single_baseline_experiment(
        ...
        experiment_code="e05x",
        raw_csv_name="e05x_results.csv",
        base_properties_path=os.path.join(THIS_DIR, "b05x.properties"),
        purpose=(
            "Shared baseline run for E05X. "
