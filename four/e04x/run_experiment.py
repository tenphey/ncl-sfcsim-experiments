#!/usr/bin/env python3
"""Shared baseline runner for E04X."""
...
if __name__ == "__main__":
    run_single_baseline_experiment(
        ...
        experiment_code="e04x",
        raw_csv_name="e04x_results.csv",
        base_properties_path=os.path.join(THIS_DIR, "b04x.properties"),
        purpose=(
            "Shared baseline run for E04X. "
