# E48Y: Standalone GHEFT / DRT-Or-IRT Gate
...
```bash
E48Y_NUM_SEEDS=1 E48Y_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e48y/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e48y/run_experiment.py
```

Dry run:

```bash
E48Y_NUM_SEEDS=1 E48Y_LIMIT_RUNS=1 E48Y_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e48y/run_experiment.py
```

Optional override:

```bash
E48Y_BASE_PROPERTIES=/absolute/path/to/file.properties
```
