#!/usr/bin/env python3
"""Shared baseline runner for E08Y."""
...
if __name__ == "__main__":
    run_single_baseline_experiment(
        ...
        experiment_code="e08y",
        raw_csv_name="e08y_results.csv",
        base_properties_path=os.path.join(THIS_DIR, "b08y.properties"),
        purpose=(
            "Shared baseline run for E08Y. "
