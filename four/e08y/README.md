# E08Y: Shared Baseline Scenario Run
...
```text
experiments/four/e08y/b08y.properties
```
...
```bash
E08Y_NUM_SEEDS=1 E08Y_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e08y/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e08y/run_experiment.py
```

Dry run:

```bash
E08Y_NUM_SEEDS=1 E08Y_LIMIT_RUNS=1 E08Y_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e08y/run_experiment.py
```

Optional override:

```bash
E08Y_BASE_PROPERTIES=/absolute/path/to/file.properties
```
...
- `e08y` as the common baseline side
