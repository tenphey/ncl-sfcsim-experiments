# E34Y: Standalone GHEFT / IRT-Only Gate
...
```bash
E34Y_NUM_SEEDS=1 E34Y_LIMIT_RUNS=1           experiments/.venv/bin/python           experiments/four/e34y/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python           experiments/four/e34y/run_experiment.py
```

Dry run:

```bash
E34Y_NUM_SEEDS=1 E34Y_LIMIT_RUNS=1 E34Y_DRY_RUN=1           experiments/.venv/bin/python           experiments/four/e34y/run_experiment.py
```

Optional override:

```bash
E34Y_BASE_PROPERTIES=/absolute/path/to/file.properties
```
