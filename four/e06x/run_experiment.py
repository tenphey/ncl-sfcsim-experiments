#!/usr/bin/env python3
"""Shared baseline runner for E06X."""
...
if __name__ == "__main__":
    run_single_baseline_experiment(
        ...
        experiment_code="e06x",
        raw_csv_name="e06x_results.csv",
        base_properties_path=os.path.join(THIS_DIR, "b06x.properties"),
        purpose=(
            "Shared baseline run for E06X. "
