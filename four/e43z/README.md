# E43Z: Standalone GHEFT / DRT-Or-IRT Gate
...
```bash
E43Z_NUM_SEEDS=1 E43Z_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e43z/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e43z/run_experiment.py
```

Dry run:

```bash
E43Z_NUM_SEEDS=1 E43Z_LIMIT_RUNS=1 E43Z_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e43z/run_experiment.py
```

Optional override:

```bash
E43Z_BASE_PROPERTIES=/absolute/path/to/file.properties
```
