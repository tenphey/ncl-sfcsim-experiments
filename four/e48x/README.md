# E48X: Standalone GHEFT / DRT-Or-IRT Gate
...
```bash
E48X_NUM_SEEDS=1 E48X_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e48x/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e48x/run_experiment.py
```

Dry run:

```bash
E48X_NUM_SEEDS=1 E48X_LIMIT_RUNS=1 E48X_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e48x/run_experiment.py
```

Optional override:

```bash
E48X_BASE_PROPERTIES=/absolute/path/to/file.properties
```
