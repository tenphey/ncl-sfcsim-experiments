#!/usr/bin/env python3
"""Standalone GHEFT runner for E21Z."""
...
GATE_VARIANT = {
    ...
    "irt_advantage": "0",
    "gate_logic": "all",
    "description": "Run only GHEFT with the DRT-only opening gate under the shared E01Z scenario.",
}
