# E37Z: Standalone GHEFT / IRT-Only Gate
...
```bash
E37Z_NUM_SEEDS=1 E37Z_LIMIT_RUNS=1           experiments/.venv/bin/python           experiments/four/e37z/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python           experiments/four/e37z/run_experiment.py
```

Dry run:

```bash
E37Z_NUM_SEEDS=1 E37Z_LIMIT_RUNS=1 E37Z_DRY_RUN=1           experiments/.venv/bin/python           experiments/four/e37z/run_experiment.py
```

Optional override:

```bash
E37Z_BASE_PROPERTIES=/absolute/path/to/file.properties
```
