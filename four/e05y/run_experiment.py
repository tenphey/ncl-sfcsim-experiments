#!/usr/bin/env python3
"""Shared baseline runner for E05Y."""
...
if __name__ == "__main__":
    run_single_baseline_experiment(
        ...
        experiment_code="e05y",
        raw_csv_name="e05y_results.csv",
        base_properties_path=os.path.join(THIS_DIR, "b05y.properties"),
        purpose=(
            "Shared baseline run for E05Y. "
