#!/usr/bin/env python3
"""Shared baseline runner for E02Y."""
...
if __name__ == "__main__":
    run_single_baseline_experiment(
        ...
        experiment_code="e02y",
        raw_csv_name="e02y_results.csv",
        base_properties_path=os.path.join(THIS_DIR, "b02y.properties"),
        purpose=(
            "Shared baseline run for E02Y. "
