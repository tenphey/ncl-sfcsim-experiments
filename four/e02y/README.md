# E02Y: Shared Baseline Scenario Run
...
```text
experiments/four/e02y/b02y.properties
```
...
```bash
E02Y_NUM_SEEDS=1 E02Y_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e02y/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e02y/run_experiment.py
```

Dry run:

```bash
E02Y_NUM_SEEDS=1 E02Y_LIMIT_RUNS=1 E02Y_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e02y/run_experiment.py
```

Optional override:

```bash
E02Y_BASE_PROPERTIES=/absolute/path/to/file.properties
```
...
- `e02y` as the common baseline side
