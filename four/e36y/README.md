# E36Y: Standalone GHEFT / IRT-Only Gate
...
```bash
E36Y_NUM_SEEDS=1 E36Y_LIMIT_RUNS=1           experiments/.venv/bin/python           experiments/four/e36y/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python           experiments/four/e36y/run_experiment.py
```

Dry run:

```bash
E36Y_NUM_SEEDS=1 E36Y_LIMIT_RUNS=1 E36Y_DRY_RUN=1           experiments/.venv/bin/python           experiments/four/e36y/run_experiment.py
```

Optional override:

```bash
E36Y_BASE_PROPERTIES=/absolute/path/to/file.properties
```
