# E36X: Standalone GHEFT / IRT-Only Gate
...
```bash
E36X_NUM_SEEDS=1 E36X_LIMIT_RUNS=1           experiments/.venv/bin/python           experiments/four/e36x/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python           experiments/four/e36x/run_experiment.py
```

Dry run:

```bash
E36X_NUM_SEEDS=1 E36X_LIMIT_RUNS=1 E36X_DRY_RUN=1           experiments/.venv/bin/python           experiments/four/e36x/run_experiment.py
```

Optional override:

```bash
E36X_BASE_PROPERTIES=/absolute/path/to/file.properties
```
