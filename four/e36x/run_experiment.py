#!/usr/bin/env python3
"""Standalone GHEFT runner for E36X."""
...
GATE_VARIANT = {
    ...
    "irt_advantage": "1",
    "gate_logic": "all",
    "description": "Run only GHEFT with the IRT-only opening gate under the shared E06X scenario.",
}
