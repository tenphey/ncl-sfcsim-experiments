# E31Y: Standalone GHEFT / IRT-Only Gate
...
```bash
E31Y_NUM_SEEDS=1 E31Y_LIMIT_RUNS=1           experiments/.venv/bin/python           experiments/four/e31y/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python           experiments/four/e31y/run_experiment.py
```

Dry run:

```bash
E31Y_NUM_SEEDS=1 E31Y_LIMIT_RUNS=1 E31Y_DRY_RUN=1           experiments/.venv/bin/python           experiments/four/e31y/run_experiment.py
```

Optional override:

```bash
E31Y_BASE_PROPERTIES=/absolute/path/to/file.properties
```
