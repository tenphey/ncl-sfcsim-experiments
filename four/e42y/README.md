# E42Y: Standalone GHEFT / DRT-Or-IRT Gate
...
```bash
E42Y_NUM_SEEDS=1 E42Y_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e42y/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e42y/run_experiment.py
```

Dry run:

```bash
E42Y_NUM_SEEDS=1 E42Y_LIMIT_RUNS=1 E42Y_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e42y/run_experiment.py
```

Optional override:

```bash
E42Y_BASE_PROPERTIES=/absolute/path/to/file.properties
```
