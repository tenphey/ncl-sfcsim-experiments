# E44Z: Standalone GHEFT / DRT-Or-IRT Gate
...
```bash
E44Z_NUM_SEEDS=1 E44Z_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e44z/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e44z/run_experiment.py
```

Dry run:

```bash
E44Z_NUM_SEEDS=1 E44Z_LIMIT_RUNS=1 E44Z_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e44z/run_experiment.py
```

Optional override:

```bash
E44Z_BASE_PROPERTIES=/absolute/path/to/file.properties
```
