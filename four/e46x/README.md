# E46X: Standalone GHEFT / DRT-Or-IRT Gate
...
```bash
E46X_NUM_SEEDS=1 E46X_LIMIT_RUNS=1   experiments/.venv/bin/python   experiments/four/e46x/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python   experiments/four/e46x/run_experiment.py
```

Dry run:

```bash
E46X_NUM_SEEDS=1 E46X_LIMIT_RUNS=1 E46X_DRY_RUN=1   experiments/.venv/bin/python   experiments/four/e46x/run_experiment.py
```

Optional override:

```bash
E46X_BASE_PROPERTIES=/absolute/path/to/file.properties
```
