#!/usr/bin/env python3
"""Shared baseline runner for E03X."""
...
if __name__ == "__main__":
    run_single_baseline_experiment(
        ...
        experiment_code="e03x",
        raw_csv_name="e03x_results.csv",
        base_properties_path=os.path.join(THIS_DIR, "b03x.properties"),
        purpose=(
            "Shared baseline run for E03X. "
