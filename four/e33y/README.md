# E33Y: Standalone GHEFT / IRT-Only Gate
...
```bash
E33Y_NUM_SEEDS=1 E33Y_LIMIT_RUNS=1           experiments/.venv/bin/python           experiments/four/e33y/run_experiment.py
```

Full default run:

```bash
experiments/.venv/bin/python           experiments/four/e33y/run_experiment.py
```

Dry run:

```bash
E33Y_NUM_SEEDS=1 E33Y_LIMIT_RUNS=1 E33Y_DRY_RUN=1           experiments/.venv/bin/python           experiments/four/e33y/run_experiment.py
```

Optional override:

```bash
E33Y_BASE_PROPERTIES=/absolute/path/to/file.properties
```
